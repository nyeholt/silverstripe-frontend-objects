...
class ObjectCreatorPageController extends PageController
{
    ...
    /**
     * Indicates whether the user-supplied parent ID is in an allowed location
     */
    protected function isParentIdValid($passedId, $ancestors = null, $type = '\Page')
    {
        if (!$ancestors) {
        ...
        while ($passedId) {
            ...
            $obj = $type::get()->byID($passedId);
            $passedId = $obj && $obj->ParentID ? $obj->ParentID : 0;
        }
